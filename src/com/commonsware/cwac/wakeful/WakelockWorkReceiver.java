...
public class WakelockWorkReceiver extends BroadcastReceiver {
    ...
    if (listener!=null) {
      if (intent.getAction()==null) {
        ...
        prefs
          ...
          .commit();
        //this retrieves a second wakelock from WakefulIntentService so that even though wakelock from onReceive ends, we have a new wakelock

 ...
 * publicity. (http://stackoverflow.com/a/6393502/1439402)
 * @author emmby
 */
public class EncryptedPreferences implements SharedPreferences {
    protected static final String UTF8 = "utf-8";
    
    private static final char[] SEKRIT = { '5', 'X', 'V', 'p', 'C', 't', 'i', 'q', 'g', 'y', '0', 'u', '6', 'v', 'y', 'c', 'Y', 'C', 'G', 'B'  };  //completely random string
    ...
    public class Editor implements SharedPreferences.Editor {
        ...
        public Editor() {
            this.delegate = EncryptedPreferences.this.delegate.edit();                    
        }
